                ...
                <div class="mt-5">
                    ...
                    <div class="space-y-4 mt-4">
                        ...
                        <div class="space-y-3">
                            ...
                            @foreach ($infoComs as $infoCom)
    <div class="flex items-center space-x-2">
        <!-- Afficher l'icône uniquement pour la première entrée -->
        <div>
            <div class="flex items-center">
                @if ($loop->first)
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 mr-2"
            ...
            {{-- <span class="text-[12px] mt-2 text-[#6F7D93]"><span class="text-gray-400 mr-2 w-5 h-5">|</span> --}}
                {{-- {{ \Carbon\Carbon::parse($infoCom->date_info)->format('d/m/Y') }}</span> --}}
                <p class="text-[#6F7D93] text-[10px] font-semibold"> {{ \Carbon\Carbon::parse($infoCom->date_info)->format('d/m/Y') }}</p>
        </div>
    </div>
@endforeach
