...
<body class="bg-[#F7F7F7] flex flex-col items-center min-h-screen">
    <div class="w-full flex justify-end">
        <img src="https://flagcdn.com/w320/ma.png" alt="Moroccan flag" class="h-7 w-11 mr-8 mt-4">
    </div>
    <div class="w-3/4 max-w-6xl p-8"> {{-- bg-white rounded-lg shadow-lg --}}
        ...
        <h2 class="class="text-center mb-8 font-['Fredoka_One','Roboto_Condensed'] font-normal text-[48px] text-[#3C4C7C]">{{ $appParameters->app_name ?? '' }}</h2>
           @endif
        <div class="flex items-center justify-center mb-8">
            ...
            <div class="text-gray-700 font-['Fredoka_One','Roboto_Condensed'] font-normal text-[14px] leading-[1.786]">
                @if (in_array($role, ['Résident', 'Manager', 'Manager principal']))
                    <p><strong>Résidence :</strong> {{ $residence->nomResidence }}</p>
                @endif
