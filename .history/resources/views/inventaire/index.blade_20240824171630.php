...
<html lang="en">
  ...
  <body>
    <div class="bg-[#F7F7F7] flex flex-row p-[20px_17px_0_10px] w-[1512px] box-sizing-border">
      <div class="rounded-[20px] bg-[#FFFFFF] relative m-[0_30px_20px_0] flex flex-col p-[38px_0_252px_0] box-sizing-border">
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/declaration_11.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#CB0B9E] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/inventory_11.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-semibold text-[12px] text-[#3C4C7C]">
          Inventaire
