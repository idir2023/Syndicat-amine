...
Prochain achat : Janvier 2024" rows="3" name="date"
                ...
                <div class="bg-[#F7F7F7] h-1 mb-6 mt-10"></div>

                <button type="submit">
                    <div
                        class="rounded-[60px] border-[1px_solid_#9EAFCE] bg-[#3C4C7C] relative flex p-[12.5px_0_12.5px_0] w-[358px]  box-sizing-border justify-center">
    ...
    @role('Super Admin|Admin|Manager principal|@extends('layouts.main')
