        ...
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full relative">
            ...
            <div class="my-[2.5rem]">
                ...
                @if ($errors->has('residenceInactive'))
                    ...
                    <p class="text-sm text-[#6F7D93]">{{ __('Votre compte résidence est actuellement inactif et vous ne pouvez pas vous connecter.
                         Veuillez contacter le personnel de votre résidence pour plus d'informations.') }}</p>
                @endif
            </div>
            <div>
