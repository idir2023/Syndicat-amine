        ...
        <div class="w-full md:w-1/3 bg-[#F7F7F7] p-8 flex flex-col justify-center items-center">
            ...
            <form class="space-y-4 w-full max-w-md" action="{{ route('login') }}" method="POST">
                ...
                <div>
                    <label
                        class="block mb-1
                    font-['Inter'] font-medium text-[16px] text-[#6F7D93]">  {{ __('Entrez Votre E-mail') }}</label>
                ...
                <div>
                    <label
                        class="block mb-1
                    font-['Inter'] font-medium text-[16px] text-[#6F7D93]">{{ __('Entrez Votre Mot de passe') }}</label>
                    <div class="flex items-center border rounded-[80px]">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}"
                                class="break-words font-['Inter'] font-medium text-[16px] text-[#3C4C7C]">{{ __('Mot de passe oublié ?') }}</a>
                        @endif
                    </div>
