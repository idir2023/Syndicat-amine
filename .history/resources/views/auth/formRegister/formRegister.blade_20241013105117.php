    ...
    <div class="text-center">
        ...
        <div class="w-full md:w-1/3 bg-[#7d8fae] text-white flex flex-col justify-center items-center text-center p-8">
            ...
            <div class="text-center space-y-6">
                ...
                <p class="mb-8">
                    {{ __('votre solution complète pour la gestion de copropriété, assurant conformité,
                ...
                <p class="mb-8">
                    {{ __('Si vous avez déjà un compte, connectez-vous maintenant et profitez pleinement de tous
                    les avantages de SynditChat!') }}
                    </p>
                <button
