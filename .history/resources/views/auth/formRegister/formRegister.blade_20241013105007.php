        ...
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
            ...
            <div class="my-[2.5rem]">
                <p class="block text-sm text-[#6F7D93] font-semibold mb-2">
                    {{ __('') }}
                    Votre formulaire a été soumis avec succès. Nous vous remercions pour votre inscription. Notre équipe examinera vos informations et vous contactera dans les plus brefs délais pour finaliser votre enregistrement.
