...
<body>
    ...
    <div class="text-center">
        <button type="submit"
            ...
            <span class="break-words font-['Inter'] font-bold text-[20px] text-[#FFFFFF]">{{ __('votre solution complète pour la gestion de copropriété, assurant conformité,
                    transparence et communication fluide'') }}</span>
        </button>
    </div>
</form>
