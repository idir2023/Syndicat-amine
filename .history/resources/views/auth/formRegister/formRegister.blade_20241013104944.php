...
<body>
    ...
    <div class="flex items-center space-x-2">
        ...
        <label class="text-gray-600">
            {{ __('') }}
            J'accepte les Conditions d'utilisation et la Politique de confidentialité de Synditchat</label>
        @error('terms')
            <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="text-center">
        <button type="submit"
            ...
            <div class="w-full flex flex-row justify-between mt-6">
                <div class="m-4 inline-block break-words font-['Inter'] font-normal text-[12px] text-[#9EAFCE]">
                    ...
                    {{ __('') }}
                        Copyrights © {{ $appParameters->copyright }}
        ...
        <div class="w-full md:w-1/3 bg-[#7d8fae] text-white flex flex-col justify-center items-center text-center p-8">
            ...
            <div class="text-center space-y-6">
                ...
                <p class="mb-8">
                    {{ __('') }}
                    votre solution complète pour la gestion de copropriété, assurant conformité,
                ...
                <p class="mb-8">
                    {{ __('') }}
                    Si vous avez déjà un compte, connectez-vous maintenant et profitez pleinement de tous
    ...
    <div id="successModal" class="fixed z-50 inset-0 flex items-center justify-center hidden bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
            <div class="flex justify-between items-center">
                <h2 class="text-lg text-[#3C4C7C] font-semibold">Félécitation !</h2>
            ...
            <div class="my-[2.5rem]">
                <p class="block text-sm text-[#6F7D93] font-semibold mb-2">Votre formulaire a été soumis avec succès. Nous vous remercions pour votre inscription. Notre équipe examinera vos informations et vous contactera dans les plus brefs délais pour finaliser votre enregistrement. Bienvenue parmi nous!</p>
            </div>
            <div>
