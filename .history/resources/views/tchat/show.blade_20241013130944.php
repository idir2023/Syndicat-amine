    ...
    <div class="p-4">
        ...
        <ul class="mt-4 space-y-2 max-h-80 overflow-y-auto contact-list custom-scrollbar">
            @forelse ($users as $usersList)
                ...
                <!-- If no avatar is available, fallback to initials or default avatar -->
                @if(!$user->avatar)
                    <div class="avatar av-s header-avatar" style="margin: 0 10px; margin-top: -5px; margin-bottom: -5px;">
