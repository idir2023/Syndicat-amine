...
<html lang="en">
  ...
  <body>
    <div class="bg-[#F7F7F7] flex flex-row p-[20px_17px_12px_10px] w-[1512px] box-sizing-border">
      <div class="rounded-[20px] bg-[#FFFFFF] relative m-[0_30px_8px_0] flex flex-col p-[38px_0_252px_0] box-sizing-border">
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/dashboard_2.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/decision_12.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
          Réglements
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/problem_solving_1.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
          Sinistre &amp; nuisance
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/documents_1.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
          Mes documents
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#CB0B9E] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/declaration_1.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-semibold text-[12px] text-[#3C4C7C]">
          Info’Com
          </div>
        </div>
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/message_31.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
          Tchat
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/inventory_1.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
          Inventaire
        ...
        <div class="m-[0_15px_25px_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/calendar_41.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
          Calendrier
        ...
        <div class="m-[0_15px_0_15px] flex flex-row self-start w-[fit-content] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[0_10px_0_0] flex p-[10px_10px_10px_10px] w-[40px] h-[40px] box-sizing-border">
            <div class="bg-[url('../assets/images/settings_41.png')] bg-[50%_50%] bg-cover bg-no-repeat w-[20px] h-[20px]">
            </div>
          </div>
          <div class="m-[12.5px_0_12.5px_0] inline-block break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
          Réglage
      ...
      <div class="flex flex-col box-sizing-border">
        <div class="rounded-[20px] bg-[#FFFFFF] relative m-[0_0_29px_0] flex flex-row justify-between p-[20px_13px_20px_20px] w-[1220px] box-sizing-border">
          <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[8px] bg-[#E9ECEE] relative m-[5px_0_5px_0] flex flex-row justify-between p-[8.5px_15px_5px_25px] w-[500px] h-[fit-content] box-sizing-border">
            <div class="m-[0_11.5px_3.5px_0] inline-block w-[323px] break-words font-['Fredoka_One','Roboto_Condensed'] font-normal text-[20px] text-[#6F7D93]">
            Résidence NOUR EL HOUDA
            </div>
            <div class="bg-[url('../assets/images/arrow_down_sign_to_navigate_1.png')] bg-[50%_50%] bg-cover bg-no-repeat m-[6.5px_0_0_0] w-[20px] h-[20px]">
            </div>
          </div>
        ...
        <div class="m-[0_0_10px_0] flex flex-row w-[fit-content] box-sizing-border">
          <div class="m-[0_20px_0_0] flex flex-col items-center box-sizing-border">
            ...
            <div class="rounded-[20px] bg-[#FFFFFF] relative m-[0_0_10px_0] flex flex-col items-center p-[17.5px_20px_26.5px_15px] w-[fit-content] box-sizing-border">
              <div class="m-[0_0_19px_0] flex flex-row justify-between w-[785px] box-sizing-border">
                <span class="m-[0_7.5px_0_0] w-[270px] break-words font-['Inter'] font-semibold text-[12px] text-[#6F7D93]">
                Coupure d’eau prévue le : 01/07/2024
                </span>
                <span class="break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
                22 Juin 2024
                </span>
              </div>
              <span class="m-[0_23.9px_0_15px] break-words font-['Inter'] font-normal text-[12px] leading-[1.333] text-[#6F7D93]">
              Nous invitons tous les habitants à prendre les dispositions nécessaires pour s&#39;y préparer. Veuillez vous assurer d&#39;avoir suffisamment d&#39;eau potable et d&#39;eau pour les usages domestiques. Nous vous remercions de votre compréhension et de votre coopération.
              </span>
            </div>
            <div class="rounded-[20px] bg-[#FFFFFF] relative m-[0_0_10px_0] flex flex-row justify-between p-[17.5px_20px_17.5px_15px] w-[820px] box-sizing-border">
              <span class="m-[0_7.5px_0_0] w-[526px] break-words font-['Inter'] font-semibold text-[12px] text-[#6F7D93]">
              Réparation finie de l’éclairage escaliers
              </span>
              <span class="break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
              18 Juin 2024
              </span>
            </div>
            <div class="rounded-[20px] bg-[#FFFFFF] relative m-[0_0_10px_0] flex flex-col p-[17.5px_20px_25px_15px] w-[fit-content] box-sizing-border">
              <div class="m-[0_0_22.5px_0] flex flex-row justify-between w-[785px] box-sizing-border">
                <span class="m-[0_7.5px_0_0] w-[270px] break-words font-['Inter'] font-semibold text-[12px] text-[#6F7D93]">
                Coupure d&#39;électricité prévue le : 17/06/2024
                </span>
                <span class="break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
                10 Juin 2024
                </span>
              </div>
              <span class="m-[0_15px_0_15px] self-start break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
              Nous invitons tous les habitants à prendre les dispositions nécessaires et à se préparer pour cette interruption. Nous vous remercions de votre compréhension et de votre coopération.
              </span>
            </div>
            <div class="rounded-[20px] bg-[#FFFFFF] relative flex flex-row justify-between p-[17.5px_20px_17.5px_15px] w-[820px] box-sizing-border">
              <span class="m-[0_7.5px_0_0] w-[526px] break-words font-['Inter'] font-semibold text-[12px] text-[#6F7D93]">
              Serrure réparée de la porte de l’immeuble
              </span>
              <span class="break-words font-['Inter'] font-normal text-[12px] text-[#6F7D93]">
              30 Mai 2024
              </span>
