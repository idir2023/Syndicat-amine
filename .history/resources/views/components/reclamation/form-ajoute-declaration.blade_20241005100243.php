<div class="w-full max-w-[330px] mx-auto"> <!-- Center the container and set max width -->
    ...
    <form method="post" action="{{ route($postUrl) }}" enctype="multipart/form-data">
        ...
        <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[20px] bg-[#FFFFFF] relative flex flex-col p-[16.5px_0_16px_0] box-sizing-border">
            ...
            <div class="m-[0_0_25px_0] flex flex-row justify-start self-start w-full box-sizing-border"> <!-- Change justify-around to justify-start -->
                <div class="flex flex-row box-sizing-border items-center"> <!-- Align items vertically -->
                    <input type="checkbox" id="nuisance" name="type[]" value="nuisance" onclick="updateSelectedTypes()" />
                    <label for="nuisance" class="ml-2 inline-block break-words font-['Inter'] text-[12px] text-[#6F7D93]">
                        Nuisance
                    </label>
                </div>
                <div class="flex flex-row box-sizing-border items-center"> <!-- Align items vertically -->
                    <input type="checkbox" id="sinistre" name="type[]" value="sinistre" onclick="updateSelectedTypes()" />
                    <label for="sinistre" class="ml-2 inline-block break-words font-['Inter'] text-[12px] text-[#6F7D93]">
                        Sinistre
                    </label>
                </div>
            </div>
