    ...
    @role('Super Admin|Admin|Manager principal|Manager')
        ...
        if (nuisanceCheckbox.checked) {
            sinistreCheckbox.disabled = true;  // Désactive l'autre case
            selectedTypeInput.value = 'nuisance';
        } else if (sinistreCheckbox.checked) {
            nuisanceCheckbox.disabled = true;  // Désactive l'autre case
            selectedTypeInput.value = 'sinistre';
        } else {
            nuisanceCheckbox.disabled = false;  // Réactive les cases si aucune sélection
            sinistreCheckbox.disabled = false;
            selectedTypeInput.value = '';  // Vide le champ caché si rien n'est sélectionné
        }
    }
        </script>
    @endrole
