<div x-data="{ open: false }">
    ...
    <form action="{{ route('document.residence', request()->route('residence') ?? Auth::user()->residence->id) }}"
        method="GET">
            ...
            <div class="bg-white rounded-lg shadow-lg w-96 p-6">
                ...
                <div class="grid grid-cols-2 gap-4 p-4 m-2 rounded-lg">
                    ...
                    <div class="flex items-center">
                        <input type="radio" id="alpha" name="order" value="alphabetical_asc"
                            class="peer hidden">
                        <label for="alpha"
                    ...
                    <!-- Option 2: Z-A -->
                    <div class="flex items-center">
                        <input type="radio" id="reverse" name="order" value="alphabetical_desc"
                            class="peer hidden">
                        <label for="reverse"
                            class="rounded-[8px] bg-[linear-gradient(90deg,#9EAFCE,#697C9B)] flex flex-row box-border 
                        hover:bg-[linear-gradient(90deg,#697C9B,#9EAFCE)] transition duration-300 ease-in-out transform hover:scale-105
                    ...
                    <div class="flex items-center">
                        ...
                        hover:bg-[linear-gradient(90deg,#697C9B,#9EAFCE)] transition duration-300 ease-in-out transform hover:scale-105
                         ...
                         <i class="fa-solid fa-sort-numeric-up-alt"></i>
                            <span
                                class="m-[0.5px_9.4px_0.5px_0] inline-block break-words font-['Inter'] font-medium text-[12px]">
                                {{ __('Trier par Date (Plus ancien)') }}Sort by Date (Oldest)
                            </span>
                        </label>
                    </div>
                </div>
                ...
                <!-- Search by Name -->
                <div>
                    <label for="name" class="sr-only">{{ __('Rechercher par nom') }}</label>
