<form action="{{ route('document.store') }}" method="POST" enctype="multipart/form-data" class="w-full max-w-[330px]">
    ...
    <div class="shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-[20px] bg-[#FFFFFF] relative m-[0_0_155px_0] flex flex-col p-[16.5px_0_18px_0] box-border">
        ...
        <input type="text" name="titre" class="rounded-[8px] border-[1px_solid_#9EAFCE] bg-[#F1F1F1] relative m-[0_25px_19.5px_25px] p-[12.5px_15px_12.5px_15px] box-border text-[12px] text-[#A2A2A2] break-words font-['Inter'] font-normal" placeholder="{{ __('Titre_du_document') }}">
        ...
        <textarea name="commentaire" class="rounded-[8px] border-[1px_solid_#9EAFCE] bg-[#F1F1F1] relative m-[0_25px_24px_25px] p-[12.5px_15px_52.5px_15px] box-border break-words font-['Inter'] font-normal text-[12px] text-[#A2A2A2]" placeholder="{{ __('Ajoutez_un_commentaire') }}"></textarea>
