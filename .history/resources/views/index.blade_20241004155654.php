...
<div class="rounded-[20px] bg-[#FFFFFF] relative m-[0_0_10px_0] flex flex-col p-[17.5px_70px_20px_15px] w-[fit-content] box-sizing-border">
    <div class="m-[0_0_27.5px_0] inline-block self-start break-words font-['Inter'] font-semibold text-[12px] text-[#6F7D93]">
        Salles de Fitness et Bien-être “ Équipements de Gymnastique “
    </div>
    <div class="m-[0_0_0_15px] flex flex-row justify-between w-[1120px] box-sizing-border">
...
<div class="rounded-[20px] bg-[#FFFFFF] relative m-[0_0_7px_0] flex flex-col p-[17.5px_70px_25px_15px] w-[fit-content] box-sizing-border">
    <div class="m-[0_0_17.5px_0] inline-block self-start break-words font-['Inter'] font-semibold text-[12px] text-[#6F7D93]">
...
<div class="rounded-[20px] bg-[#FFFFFF] relative flex flex-col p-[17.5px_70px_12.5px_15px] w-[fit-content] box-sizing-border">
    <div class="m-[0_0_20px_0] inline-block self-start break-words font-['Inter'] font-semibold text-[12px] text-[#6F7D93]">
