            ...
            <div class="m-header">
                <nav>
                    ...
                    <nav class="m-header-right">
                        ...
                        <a id="groupLink" href="javascript:void(0);" class="getGroup rounded-[6px] bg-gradient-to-r from-[#9EAFCE] to-[#697C9B] p-[4px] w-[24px] h-[24px] flex justify-center items-center cursor-pointer">
