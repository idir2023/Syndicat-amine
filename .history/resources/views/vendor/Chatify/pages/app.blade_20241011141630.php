        ...
        <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
            ...
            <div class="m-header">
                <nav>
                    ...
                    <nav class="m-header-right">
                        ...
                        <a href="{{ route('getGroup') }}" class="getGroup rounded-[6px] bg-gradient-to-r from-[#9EAFCE] to-[#697C9B] p-[4px] w-[24px] h-[24px] flex justify-center items-center cursor-pointer">
            ...
            <div class="m-body contacts-container">
                ...
                <div class="show messenger-tab users-tab app-scroll" data-view="users">
                    ...
                    {{-- Contacts --}}
                    <p class="messenger-title"><span>Toutttt les messages</span></p>
