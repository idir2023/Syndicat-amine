            ...
            <div class="m-header">
                <nav>
                    ...
                    <nav class="m-header-right">
                        ...
                        <a href="" class="getGroup rounded-[6px] bg-gradient-to-r from-[#9EAFCE] to-[#697C9B] p-[4px] w-[24px] h-[24px] flex justify-center items-center cursor-pointer">
        ...
        <div class="messenger-messagingView">
            ...
            <div class="m-header m-header-messaging">
                <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <a href="#" class="add-to-favorite"><i class="fas fa-star custom-icon"></i></a>
<a href="/" class="custom-icon"><i class="fas fa-home"></i></a>
<a href="#" class="show-infoSide"><i class="fas fa-info-circle custom-icon"></i></a>
