...
Route::get('/tchat', [InfocomController::class, 'index'])->name('tchat');

Route::get('/inventaire', [InfocomController::class, 'index'])->name('inventaire');

Route::get('/reglages', [InfocomController::class, 'index'])->name('reglages');

Route::get('/calendrie', [InfocomController::class, 'index'])->name('infocom');
