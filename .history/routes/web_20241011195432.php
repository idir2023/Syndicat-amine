...
Route::get('/language-form', [LocaleController::class, 'showLanguageForm'])->name('locale.form');
...
Route::get('/get-group-users', [GroupController::class, 'getGroups'])->name('chatify.getGroups');
