...
class DashbordController extends Controller
{
    public function index()
    {
        ...
        $roleOrder = ['Manager principal', 'Manager', 'Proprétaire', 'Résident', 'Admin', 'Super Admin', 'residence'];
        ...
        // Appliquer le tri par ordre personnalisé
        $roleCounts = collect($roleCounts)->sortBy(function ($count, $roleName) use ($roleOrder) {
