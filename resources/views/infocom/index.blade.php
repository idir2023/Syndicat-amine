...
@section('content')
    ...
    <div class="flex flex-col w-full">
        ...
        <div class="pb-[27px] flex flex-row justify-between w-full">
            <div class="font-semibold text-[14px] text-[#3C4C7C] mr-[8.5px]">{{ __('messages.InfoCom') }}</div>
            <a href="#" onclick=""
                class="rounded-[8px] bg-gradient-to-r from-[#9EAFCE] to-[#697C9B] flex flex-row items-center px-[18px] py-[4px]">
                <span class="text-white text-[12px] font-medium mr-[17.9px]">{{ __('messages.Filter') }}</span>
        ...
        <div class="flex flex-row justify-between">
            ...
            @role('superadmin|admin|manager principal|manger')
                <form
                    ...
                    <div class="text-[14px] font-semibold text-[#3C4C7C] mb-[26.5px] px-[25px]">{{ __('messages.Add') }}</div>

                    <div class="bg-[#F7F7F7] h-[1px] mb-[24.5px] w-full max-w-[380px] mx-auto"></div>

                    <div class="text-[12px] font-medium text-[#6F7D93] mb-[12.5px] px-[25px]">{{ __('messages.SelectRecipient') }}</div>
                    ...
                    <div class="text-[12px] font-medium text-[#6F7D93] mb-[12.5px] px-[25px]">{{ __('messages.EnterTitle') }}</div>
                    <div class="border border-[#9EAFCE] rounded-[8px] bg-[#F1F1F1] p-[12.5px] mb-[19.5px] mx-[25px]">
                        <input type="text" name="titre"
                            ...
                            placeholder="{{ __('messages.ExampleTitle') }}">
                    </div>

                    <div class="text-[12px] font-medium text-[#6F7D93] mb-[12.5px] px-[25px]">{{ __('messages.EnterDescription') }}</div>
                    <div class="border border-[#9EAFCE] rounded-[8px] bg-[#F1F1F1] p-[17px_15px] mb-[40px] mx-[25px]">
                        <textarea name="description"
                            ...
                            placeholder="{{ __('messages.ExampleDescription') }}"></textarea>
                    </div>
